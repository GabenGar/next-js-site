export type {
  ...
  YaDiskPublicResourceList as IYaDiskPublicResourceList,
  YaDiskPublicResource as IYaDiskPublicResource,
  ...
  YaDiskUserPublicInformation as IYaDiskUserPublicInformation,
